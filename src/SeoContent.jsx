  ...
  return (
    <section style={styles.section}>
      <div style={styles.container}>
        <h1 style={styles.h1}>
          La Route des Orques : comprendre le phénomène et naviguer en sécurité
        </h1>
        <p style={styles.intro}>
          Depuis 2020, des interactions entre orques et voiliers se multiplient le long des
          côtes ibériques, du Golfe de Gascogne jusqu'au détroit de Gibraltar. Ces rencontres,
          parfois impressionnantes, concernent chaque année plusieurs centaines de plaisanciers.
          <strong> La Route des Orques</strong> a été créée pour aider les navigateurs à mieux
          anticiper ces zones et à naviguer ensemble, plus en sécurité.
        </p>
        ...
        <p style={styles.p}>
          ...
          l'application permet de <strong>naviguer en convoi dans les zones à orques</strong>.
          Concrètement :
        </p>
        <ul style={styles.ul}>
        ...
        <p style={styles.p}>
          ...
          Orques met l'accent sur l'entraide entre plaisanciers : traverser une zone à risque à
        ...
        <p style={styles.footer}>
          ...
          plaisanciers. Elle propose des alertes en temps réel, une carte marine interactive, la
          formation de convois et des notifications push, disponible en français, anglais,
